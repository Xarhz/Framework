...
RegisterNUICallback("pluto-hud:setKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
  -- data.value = value
  ...
  TriggerEvent("pluto-hud:settings", data.key, data.value)
...
RegisterNUICallback("pluto-hud:getKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
...
function GetPreferences()
  local result = GetResourceKvpString('pluto-preferences')
