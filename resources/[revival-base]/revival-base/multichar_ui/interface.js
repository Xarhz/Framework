...
addEventListener("message", ({data}) => {
    switch (data.action) {
        ...
        case "updateSettings":
            ...
            if (data.scoreboard) {
                $.post('https://revival-base/PlayerList', JSON.stringify({}));
            } else {
...
$(document).on('click','.character',function(){
    ...
    //     canClick = false;
        ...
        // if ($(".selectChar").data("clicked") && $(".deleteChar").data("clicked")) {
            $.post('https://revival-base/createPed', JSON.stringify({
                ["cid"]: lastCid,
                // ["clicked"]: true,
            }));
        // } else {
...
$(document).on("click", ".saveSettings", () => {
    ...
    $.post(
        'https://revival-base/updateSettings', 
        JSON.stringify({
...
$(document).on('click','.selectChar',function(){
    ...
    $.post('https://revival-base/selectCharacter', JSON.stringify({
        ["cid"]: lastCid
    }));
});
...
$(".delete").click(function(){
    ...
    $.post('https://revival-base/deleteCharacter', JSON.stringify({
        ["cid"]: cid
    }));
...
$(".submit").click(function(){
    ...
    $.post('https://revival-base/createCharacter', JSON.stringify({
        ["charData"]: data
    }))
});
...
$(".playButton").click(function(){
    $(".init").hide();     
    $.post('https://revival-base/play', JSON.stringify({}))
    return
})