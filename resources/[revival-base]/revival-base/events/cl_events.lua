...
RegisterNetEvent('revival-base:tpm')
AddEventHandler('revival-base:tpm', function()
...
RegisterNetEvent('revival-base:GoToPlayer')
AddEventHandler('revival-base:GoToPlayer', function(othersource)
	local coords = RevivalCore.GetCoords(GetPlayerPed(GetPlayerFromServerId(othersource)))
...
RegisterNetEvent('revival-base:GoToCoords')
AddEventHandler('revival-base:GoToCoords', function(x, y, z)
	local entity = PlayerPedId()
	if IsPedInAnyVehicle(entity, false) then
		entity = GetVehiclePedIsUsing(entity)
	end
...
RegisterNetEvent('revival-base:revive')
AddEventHandler('revival-base:revive', function() -- need to work with the ragdoll
	local coords = RevivalCore.GetCoords(PlayerPedId())
	NetworkResurrectLocalPlayer(coords.x, coords.y, coords.z+0.2, coords.a, true, false)
	SetPlayerInvincible(PlayerPedId(), false)
	ClearPedBloodDamage(PlayerPedId())
end)

RegisterNetEvent('revival-base:SpawnVehicle')
AddEventHandler('revival-base:SpawnVehicle', function(veh)
	...
	TriggerEvent("revival-parking:addKeys",spawned_car,GetVehicleNumberPlateText(spawned_car))
...
RegisterNetEvent('revival-base:DeleteVehicle')
AddEventHandler('revival-base:DeleteVehicle', function()
    local playerPed = PlayerPedId()
	local vehicle   = RevivalCore.GetClosestVehicle()
	...
	if DoesEntityExist(vehicle) then
		RevivalCore.DeleteVehicle(vehicle)
		TriggerEvent('notification', 'Vehicle Deleted',3)
	end
end)

RegisterNetEvent('revival-base:playSound')
AddEventHandler('revival-base:playSound', function(sound, set)
	PlaySoundFrontend(-1, sound, set, false)
end)

RegisterNetEvent('revival-base:refreshPlayer')
AddEventHandler('revival-base:refreshPlayer', function()
	TriggerServerEvent('revival-base:refreshPlayer', RevivalCore.LocalPlayer)
end)
...
RegisterNetEvent("revival-base:noclip")
AddEventHandler("revival-base:noclip", function(t)
    ...
    TriggerEvent('revival-base:startNoClip')
end)
...
RegisterNetEvent('revival-base:startNoClip')
AddEventHandler('revival-base:startNoClip', function()
