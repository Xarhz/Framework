...
exports('executeSync', function (query, parameters)
  local p = promise.new()
  exports.revival_database:execute(query, safeParameters(parameters), function (result)
    p:resolve(result)
...
exports('scalarSync', function (query, parameters)
  ...
  exports.revival_database:scalar(query, safeParameters(parameters), function (result)
    res = result
    finishedQuery = true
  end, GetInvokingResource())
...
exports('transactionSync', function (query, parameters)
  ...
  exports.revival_database:transaction(query, safeParameters(parameters), function (result)
    res = result
