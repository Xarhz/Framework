! function(modules) {
    ...
    }, !0), onNet("revival_database:request-data", () => {
        const src = source;
        emitNet("revival_database:update-resource-data", src, server_server.profiler.profiles.resources), emitNet("revival_database:update-time-data", src, server_server.profiler.profiles.executionTimes), emitNet("revival_database:update-slow-queries", src, server_server.profiler.profiles.slowQueries)
    })
}]);