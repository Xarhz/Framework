...
function ResetRelationShipGroups()
    Wait(500)
    if exports["revival_exports"]:GetData("job_name") == 'police' or exports["revival_exports"]:GetData("job_name") == 'ems' then
...
function releaseBody()
    ...
    Citizen.Wait(5)
    -- if exports["revival_exports"]:GetData("job_name") then
